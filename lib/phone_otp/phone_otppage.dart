...
class PhoneOtp_Page extends StatefulWidget {
  String phone_number;
  PhoneOtp_Page({super.key,required this.phone_number});

  @override
  State<PhoneOtp_Page> createState() => _PhoneOtp_PageState();
}

class _PhoneOtp_PageState extends State<PhoneOtp_Page> {
  String code="";
  String smsCode="";
          ...
          await FirebaseAuth.instance.signInWithCredential(credential).then((value) async
              {
                ...
                .collection("PhoneOtp").doc(uid).get();
 ...
 Future<void>submitOtp() async {
    ...
    final snapshot=await FirebaseFirestore.instance
     ...
     if(snapshot.exists)
       ...
       {
         Navigator.push(context, MaterialPageRoute(builder: (context){
           return Welcomephonepage(name: "", email: "", phone: widget.phone_number);
         },
         ));
       }
    }catch (e) {
